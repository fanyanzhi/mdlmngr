...
/**
 * Servlet implementation class CommentSearchListServlet
 */
@WebServlet("/CommentSearchList.do")
public class CommentSearchListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommentSearchListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("HandlerURL", "CommentSearchListHandler.do");
		request.getRequestDispatcher("/CommentMngr/commentsearchlist.jsp").forward(request, response);
	}
