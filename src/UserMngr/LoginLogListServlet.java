...
/**
 * Servlet implementation class LoginLogListServlet
 */
@WebServlet("/LoginLogList.do")
public class LoginLogListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginLogListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("HandlerURL", "LoginLogListHandler.do");
		request.getRequestDispatcher("/UserMngr/loginloglist.jsp").forward(request, response);
	}
