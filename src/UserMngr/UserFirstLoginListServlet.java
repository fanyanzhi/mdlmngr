 ...
 */
@WebServlet("/UserFirstLoginList.do")
public class UserFirstLoginListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserFirstLoginListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("HandlerURL", "UserFirstLoginListHander.do");
		request.getRequestDispatcher("/UserMngr/userfirstloginlist.jsp").forward(request, response);
	}
