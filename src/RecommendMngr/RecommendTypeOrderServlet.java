 ...
 */
@WebServlet("/RecommendTypeOrder.do")
public class RecommendTypeOrderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendTypeOrderServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("HandlerURL", "RecommendTypeOrderHandler.do");
		request.getRequestDispatcher("/RecommendMngr/recommendtypeorder.jsp").forward(request, response);
