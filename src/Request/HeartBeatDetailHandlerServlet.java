 ...
 */
@WebServlet("/HeartBeatDetailHandler.do")
public class HeartBeatDetailHandlerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public HeartBeatDetailHandlerServlet() {
		super();
	...
	private String getDownloadFileCount(HttpServletRequest request) throws ServletException, IOException {
		...
		return String.valueOf(BehaviourMngr.getHeartBeatCount(strUserName, strClientID, strStartDate, strEndDate));
	}
	...
	private String getDownloadFileList(HttpServletRequest request) throws ServletException, IOException {
		...
		while (iFile.hasNext()) { // id,username,filename,fileid,client,address,time
			...
			sbHtml.append("<td class=\"tabcent\"><a href=\"HeartBeatClientidDetal.do?clientid=").append(iMap.get("clientid")).append("\">").append(iMap.get("clientid")).append("</td>");
