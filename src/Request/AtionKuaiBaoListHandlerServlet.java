 ...
 */
@WebServlet("/AtionKuaiBaoListHandler.do")
public class AtionKuaiBaoListHandlerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AtionKuaiBaoListHandlerServlet() {
        super();
	...
	private String getAtionCount(HttpServletRequest request) throws ServletException, IOException {
		...
		return String.valueOf(KuaiBaoMngr.getKuaiBaoCount(strXueKeCode, strUserName, strStartDate, strEndDate));
	}
...
//		String strXueKeName = request.getParameter("xn");
		...
		lstFiles = KuaiBaoMngr.getKuaiBaoList(strXueKeCode, strUserName, strStartDate, strEndDate, iStart, iLength);
		if (lstFiles == null) {
			return "";
		}
	...
	private String delAtionFile(HttpServletRequest request) throws ServletException, IOException {
		...
		if (KuaiBaoMngr.delAttention(strUserName, strFileID)) {
			strResult = "1";
		} else {
			strResult = "0";
		}
	...
	private String getUserCount(HttpServletRequest request) throws ServletException, IOException {
		...
		String strStartDate = request.getParameter("startdate");
		String strEndDate = request.getParameter("enddate");
		return String.valueOf(KuaiBaoMngr.getKuaiBaoUserCount(strXueKeCode, strUserName, strStartDate, strEndDate));
	}
