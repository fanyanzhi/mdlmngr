...
/**
 * Servlet implementation class ThirdLoginCallBackServlet
 */
@WebServlet("/ThirdLoginCallBack.do")
public class ThirdLoginCallBackServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThirdLoginCallBackServlet() {
        super();
...
//				request.setAttribute("errmsg","没有获取到响应参数");
//			} else {
