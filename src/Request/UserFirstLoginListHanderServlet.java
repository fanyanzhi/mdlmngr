 ...
 */
@WebServlet("/UserFirstLoginListHander.do")
public class UserFirstLoginListHanderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserFirstLoginListHanderServlet() {
        super();
	...
	private String delUserLoginLog(HttpServletRequest request) throws ServletException, IOException {
		...
		if (UserFirstLogMngr.delUserLoginLog(strLogID, strUserName)) {
			strResult = "1";
		} else {
			strResult = "0";
		}
	...
	private String getUserLoginCount(HttpServletRequest request) throws ServletException, IOException {
		...
		String strUserName = request.getParameter("uname");
		return String.valueOf(UserFirstLogMngr.getUserLoginCount(appid, strUserName, strStartDate, strEndDate));
	}
	...
	private String getUserLoginList(HttpServletRequest request) throws ServletException, IOException {
		...
		lstUserLoginLog = UserFirstLogMngr.getUserLoginList(appid, strUserName, strStartDate, strEndDate, iStart, iLength);
