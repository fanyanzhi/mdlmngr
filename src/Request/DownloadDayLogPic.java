 ...
 */
@WebServlet("/DownloadDayLogPic.do")
public class DownloadDayLogPic extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DownloadDayLogPic() {
		super();
	...
	private String getOnlinePic(HttpServletRequest request) {
		...
		List<Map<String, Object>> lstInfo = DownloadMngr.getDownloadDayLog(strStartDate,strEndDate);
		if (lstInfo == null) {
			return null;
		}
