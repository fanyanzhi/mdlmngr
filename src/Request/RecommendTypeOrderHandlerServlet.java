 ...
 */
@WebServlet("/RecommendTypeOrderHandler.do")
public class RecommendTypeOrderHandlerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecommendTypeOrderHandlerServlet() {
        super();
	...
	private String saveRecomdSourceType(HttpServletRequest request) throws ServletException, IOException {
		String appid = request.getParameter("selappid");
		...
		if(RecommendationInfoMngr.saveRecomTypeOrder(appid, lstRecomType)){
			return "1";
		}else{
			return "0";
		}		
	...
	protected String getSourceTypeList(HttpServletRequest request) throws ServletException, IOException {
		...
		List<Map<String, Object>> lstSourceType = RecommendationInfoMngr.getRecommendationTypeList(appid);
		...
		while (iMap.hasNext()) {
			...
			sbHtml.append("<tr>");
			sbHtml.append("<td> <a href=\"javascript:void(0)\" class=\"downbtn\" title=\"向上\" onclick=\"ordergoup(this);\"></a> <a href=\"javascript:void(0)\" class=\"upbtn\" title=\"向下\" onclick=\"ordergodown(this);\"></a> </td>");
