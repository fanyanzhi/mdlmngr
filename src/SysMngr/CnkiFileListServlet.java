...
/**
 * Servlet implementation class CnkiFileListServlet
 */
@WebServlet("/CnkiFileList.do")
public class CnkiFileListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CnkiFileListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("HandlerURL", "CnkiFileListHandler.do");
		String strTypeCH ="";
		//String strTypeEN="";
		...
		request.getRequestDispatcher("/SysMngr/cnkifilelist.jsp").forward(request, response);
	}
