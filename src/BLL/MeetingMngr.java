...
public class MeetingMngr {
	
	public static String checkAttention(String userName, String code) {
		String strRet = "0";
		DBHelper dbHelper = null;
		String strTableName = getTableName("usermeet", userName);
		try {
	...
	public static int getMeetingAllCount(String sortcode, String UserName, String StartDate, String EndDate) {
	...
	public static List<Map<String, Object>> getMeetingList(String sortcode,String UserName, String StartDate, String EndDate, int Start, int Length) {
	...
	public static String getMeetingUserCount(String sortcode, String UserName, String StartDate, String EndDate) {
		StringBuilder sbCondition = new StringBuilder();
		DBHelper dbHelper = null;
		try {
			dbHelper = DBHelper.GetInstance();
		...
		for(int i = 0; i < 10; i++){
			try {
				lstCount = dbHelper.ExecuteQuery("count(DISTINCT username) cut", "usermeet" + i, sbCondition.toString());
			} catch (Exception e) {
