	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				...
				<div class="mdlrignav">
				<a href="LoginLogList.do" class="fleft return">返回</a>  <a href="UserLoginList.do" class="addblock fleft">登录日志</a><a href="BrowseSearch.do" class="addblock fleft">浏览检索</a>
					<div class="search" style="width: 600px; margin-left: -300px;">
						<span>开始时间：<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" />&nbsp;&nbsp;结束时间：<input id="txtEndDate" name="txtEndDate" type="text" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" class="timetstyle" /><input name="" class="searchbtn" type="button" onclick="getUserCountPic();" value="查询" /></span>
					</div>
				</div>
			...
			success : function(data) {
				...
				if (data.length > 0) {
					...
					$.each(jsonarray,function(i, n){
					    ...
					    var pointusercount=[n.usercount];
					    dateArray[i]=pointdata;
					    userArray[i]=Number(pointusercount);
