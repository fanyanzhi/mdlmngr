	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				...
				<div class="mdlrignav">
				<a href="UserLoginDayLog.do" class="fleft return">返回</a>
		...
		$.ajax({
			...
			success : function(data) {
				...
				if (data.length > 0) {
					...
					var browseArray = new Array();
					$.each(jsonarray,function(i, n){
					    var pointdata=[n.date];
					    var pointcount=[n.seacount];
					    var pointbrocount=[n.brocount];
					    dateArray[i]=pointdata;
					    browseArray[i]=Number(pointbrocount);
					    searchArray[i]=pointcount;
					});
					 $('#divdata').highcharts({
							 credits:{
