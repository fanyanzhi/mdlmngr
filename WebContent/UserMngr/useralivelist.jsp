...
<body>
			...
			<div id="mdlright">
				...
				<a href="StatisticAnalysis.do" class="fleft return">返回</a>
					<div class="search" style="width: 600px; margin-left: -300px;">
						<span>开始时间：<input id="txtStartDate" name="txtStartDate" type="text" value="${StartDate }" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" />&nbsp;&nbsp;结束时间：<input id="txtEndDate" name="txtEndDate" type="text"  value="${EndDate }" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" class="timetstyle" /><input name="" class="searchbtn" type="button" onclick="getUserAliveList();" value="查询" /></span> 
					</div>
				</div>
	...
	window.setInterval(getUserAliveList,30000); 
	function getUserAliveList() {
		showLoading();
