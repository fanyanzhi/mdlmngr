...
<body>
				...
				<div class="mdlrignav">
					<div class="longpadrig">
						<div class="longsearch">
							...
							<span>开始时间：
								<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" />&nbsp;&nbsp;
								结束时间：
								<input id="txtEndDate" name="txtEndDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" />
								<input id="searchBtn" class="searchbtn" type="button" value="查询" />
							</span>
						</div>
	...
	<script type="text/javascript">
		...
		function load() {
			...
			var varcon = "";
			varcon += "txtStartDate=" + $("#txtStartDate").val() + "&"
