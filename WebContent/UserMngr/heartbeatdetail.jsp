...
<body>
	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				...
				<div class="mdlrignav">
					<a href="StatisticAnalysis.do" class="fleft return">返回</a><a href="UserHeartBeat.do" class="addblock fleft">用户统计</a>
					<div class="longpadrig">
						<div class="longsearch">
							开始时间：<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" />&nbsp;&nbsp; 结束时间：<input id="txtEndDate" name="txtEndDate" type="text" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" class="timetstyle" />&nbsp;&nbsp;&nbsp; 用户名：<input type="text" id="txtUserName" name="txtUserName" class="searchkey" />&nbsp;&nbsp;&nbsp;设备ID：<input type="text" id="txtClientID" name="txtClientID" class="searchkey" /> <input name="" class="searchbtn" type="button" onclick="getHeartBeatDetail();" value="查询" />
						</div>
	...
	<script type="text/javascript">
		...
		function clientidDetail(clientid) {
			location.href = "HeartBeatClientidDetal.do?clientid=" + clientid;
		}
	</script>
</body>
</html>