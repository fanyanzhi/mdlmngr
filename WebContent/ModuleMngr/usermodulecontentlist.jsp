			...
			<script language="javascript" type="text/javascript" src="js/PopupCalendar.js"></script>
				<div class="mdlrignav">
					<div class="search" style="width:710px;margin-left:-300px;">
						<span>用户名：<input id="txtUserName" name="txtUserName" class="searchkey" value="" type="text"/></span>
						<span>开始时间：<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);"/>&nbsp;&nbsp;结束时间：<input id="txtEndDate" name="txtEndDate" type="text" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" class="timetstyle" /><input name="" class="searchbtn" type="button" onclick="getUserModuleContent();" value="查询" /></span>
					</div>
				...
				<div class="mdlrigcontent" id="mdlrigcon">
					<div id="divdata"></div>
					<div class="botopt">
					<div class="botleftopt"> <input name="selectAll" id="selectAll" onclick="checkall('tabUserContent',this)" type="checkbox" value=""/><a href="javascript:void(0);" onclick="delMultiUserCon()"  class="delall">删除</a> </div>
