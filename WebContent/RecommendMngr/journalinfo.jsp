			...
			<div id="mdlright">
				...
				<div class="mdlrigcontent">
					<div class="detailbtnbox journalbtn">
						<h1 class="journalname"><span id="spjn">${JournalInfo.title}</span></h1>
					...
					<div class="journal" style="display: block;">
						...
						<div class="journalinfo">
							<p>刊名： ${JournalInfo.title}</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${JournalInfo.titleen }</p>						
							<p>主办：${JournalInfo.author }</p>
							<p>周期： ${JournalInfo.type }</p>
							<p>出版地：${JournalInfo.address }</p>
							<p>语种： ${JournalInfo.language }</p>
							<p>开本： ${JournalInfo.size }</p>
							<p>ISSN： ${JournalInfo.issn }</p>
							<p>CN： ${JournalInfo.cn}</p>
							<p>邮发代号：${JournalInfo.mailcode }</p>
							<p>复合影响因子：${JournalInfo.impactfactor }</p>
							<p>综合影响因子：${JournalInfo.compositeimpactfactor }</p>
						</div>
					</div>
