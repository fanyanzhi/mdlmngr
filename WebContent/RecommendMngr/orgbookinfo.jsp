			...
			<div id="mdlright">
				...
				<div class="mdlrigcontent">
					<div class="detailbtnbox journalbtn">
						<h1 class="journalname"><span id="spjn">${orgBookInfo.booktitle}</span></h1>
					...
					<div class="journal" style="display: block;">
						...
						<div class="journalinfo">
							<p>书名： ${orgBookInfo.booktitle}</p>
							<p>主编：${orgBookInfo.creator}</p>
							<p>出版社：${orgBookInfo.publisher}</p>
							<p>出版地：${orgBookInfo.publisher }</p>
							<p>出版日期： ${orgBookInfo.publishdate}</p>
							<p>定价： ${orgBookInfo.bookprice }</p>
							<p>电子版定价： ${orgBookInfo.electronicprice }</p>
							<p>ISSN： ${orgBookInfo.issn}</p>
							<p>页码： ${orgBookInfo.pageno}</p>
							<p>开本： ${orgBookInfo.size}</p>
							<p>摘要： ${orgBookInfo.summary}</p>
						</div>
					</div>
