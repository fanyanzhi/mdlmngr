...
<body>
	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				<div class="mdlrignav"> <a href="RecommendTypeOrder.do" class="return fleft">返回</a>
					<div class="search">
						AppID：
							<select style="width: 150px; height: 28px; line-height: 28px; text-indent: 10px;font-size:15px;" onchange="getRemSourceTypeList()" id="selappid" name="selappid">
