	...
	<div id="main">
		...
		<div id="mdlright">
			<div class="mdlrignav conmendnav">
				<a href="RecommendSearch.do" class="return fleft">返回</a>
			...
			<div class="mdlrigcontent" id="mdlrigcon">
				...
				<div class="botopt" id="divbotopt" style="display:none">
					<div class="botleftopt">
						<input  name="selectAll" id="selectAll" onclick="checkall('tabarticle',this)" type="checkbox" value="" /><a href="javascript:void(0)" onclick="RemmondAll()" class="delall">推荐</a>
					</div>
