			...
			<div id="mdlright">
				...
				<div class="mdlrigcontent">
					<div class="detailbtnbox journalbtn">
						<h1 class="journalname"><span id="spjn">${orgJournalInfo.journalname}</span></h1>
					...
					<div class="journal" style="display: block;">
						...
						<div class="journalinfo">
							<p>刊名： ${orgJournalInfo.journalname}</p>
							<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${orgJournalInfo.journalnameen}</p>						
							<p>主编：${orgJournalInfo.creator}</p>
							<p>出版地：${orgJournalInfo.publisher }</p>
							<p>语种： ${orgJournalInfo.language }</p>
							<p>ISSN： ${orgJournalInfo.issn }</p>
							<p>CN： ${orgJournalInfo.cn}</p>
							<p>出版日期： ${orgJournalInfo.publishdate}</p>
							<p>摘要： ${orgJournalInfo.summary}</p>
						</div>
					</div>
