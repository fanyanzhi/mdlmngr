...
<body>
	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<input type="hidden" id="hidsubjectid" name="hidsubjectid" value="${noticeId}" /> 
			<input type="hidden" id="hidsubjectname" name="hidsubjectname" value="${noticeTitle}" /> 
	...
	function importCsv() {
		...
		if(!((/(?:xls)$/i.test($("#orgfile").val()))||(/(?:xlsx)$/i.test($("#orgfile").val())))) { 
			alert("只允许导入excel的数据"); 
			return;
		}
		$.ajaxFileUpload({
