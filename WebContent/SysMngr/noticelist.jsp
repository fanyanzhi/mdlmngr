...
<body>
	...
	<div id="main">
		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				<div class="mdlrignav">
					<a href="PublishNotice.do" class="addblock">发布通知</a>
				...
				<div class="mdlrigcontent" id="mdlrigcon">
					<div id="divdata"></div>
					<div class="botopt">
					<div class="botleftopt"> <input name="selectAll" id="selectAll" onclick="checkall('tabnotice',this)" type="checkbox" value=""/><a href="javascript:void(0);" onclick="delMultiShip()"  class="delall">删除</a> </div>
