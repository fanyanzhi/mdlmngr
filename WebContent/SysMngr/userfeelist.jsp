				...
				<div class="mdlrignav">
					<div class="longpadrig">
						<div class="longsearch">
							<span style="margin-left: 200px">用户名：<input id="txtUserName" name="txtUserName" class="searchkey" type="text" value=""/></span>
							<span>开始时间：<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);"/>&nbsp;&nbsp;
					               ...
					               <input name="" class="searchbtn" type="button" onclick="getUserFreeContext();" value="查询" />
			        		</span>
			        		<span style="margin-left: 10px; class="total">收费总额为 ： </span>
			        		<span id="feeCountSpan" class="total" style="color:#C00"></span>
