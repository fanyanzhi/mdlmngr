...
<body>
			...
			<script language="javascript" type="text/javascript" src="js/PopupCalendar.js"></script>
				...
				<div class="longpadrig">
					<div class="longsearch">
							...
							出版物名称：<input type="text" id="txtFileName" name="txtFileName" class="searchkey" />
							appid：<input type="text" id="txtappid" name="txtappid" class="searchkey" />
							...
							<input name="" class="searchbtn" type="button" onclick="getAtionChuBanWu();" value="查询" />
	...
	function getAtionChuBanWu(){
		...
		if ($.trim($("#txtappid").val()).length > 0) {
			varcon += "ad=" + encodeURI($.trim($("#txtappid").val())) + "&";
		}
