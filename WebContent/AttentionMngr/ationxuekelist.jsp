...
<body>
			...
			<script language="javascript" type="text/javascript" src="js/PopupCalendar.js"></script>
				...
				<div class="longpadrig">
					<div class="longsearch">
							...
							学科ID：<input type="text" id="txtXueKeId" name="txtXueKeId" class="searchkey" />
							...
							<input name="" class="searchbtn" type="button" onclick="getAtionXueKe();" value="查询" />
	...
	<script type="text/javascript">
		...
		function getAtionXueKe(){
			var varcon = "";
			if ($.trim($("#txtUserName").val()).length > 0) {
				varcon += "un=" + encodeURI($.trim($("#txtUserName").val())) + "&";
			}
			if ($.trim($("#txtXueKeId").val()).length > 0) {
				varcon += "xi=" + encodeURI($.trim($("#txtXueKeId").val())) + "&";
			}
