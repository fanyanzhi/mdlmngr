			...
			<script language="javascript" type="text/javascript" src="js/PopupCalendar.js"></script>
				...
				<div class="longpadrig">
					<div class="longsearch">	
						...
						AppID:<select id="selappid" name="selappid">
							...
							文件名：<input type="text" id="txtFileName" name="txtFileName" class="searchkey" />&nbsp;&nbsp;用户名：<input type="text" id="txtUserName" name="txtUserName" class="searchkey" />&nbsp;&nbsp;&nbsp;机构名：<input type="text" id="txtOrgName" name="txtOrgName" class="searchkey" style="width:90px" />&nbsp;&nbsp; 是否机构：<select id="selIsOrg"><option value="">全部</option><option value="1">是</option><option value="0">否</option></select>&nbsp;&nbsp;&nbsp;开始时间：<input id="txtStartDate" name="txtStartDate" type="text" class="timetstyle" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);"/>&nbsp;&nbsp;
					               	 结束时间：<input id="txtEndDate" name="txtEndDate" type="text" onclick="window.parent.getDateString(this,window.parent.oCalendarChs,0);" autocomplete="off" class="timetstyle" /><input name="" class="searchbtn" type="button" onclick="getDownloadFiles();" value="查询" />
					</div>
				...
				<div class="mdlrigcontent" id="mdlrigcon">
					...
					<div class="botopt">
						...
						<a href="DownloadTrace.do" class="addblock" style="float:left">下载追踪</a>
						<a href="DownloadDayLog.do" class="addblock" style="float:left">下载统计</a>
						</c:if>
						</div>
