		...
		<form id="form1" name="form1">
			...
			<div id="mdlright">
				<div class="mdlrignav">
					...
					<div class="search">
						<input name="txtTitle" id="txtTitle" type="text" class="keyword" /><input name="" class="searchbtn" type="button" onclick="getPraiseList();" value="查询" />
					</div>
				...
				<div class="mdlrigcontent" id="mdlrigcon">
					...
					<div class="botopt">
						<div class="botleftopt">
							<input name="selectAll" id="selectAll" onclick="checkall('tabpraise',this)" type="checkbox" value="" /><a href="javascript:void(0)" onclick="delMultiPraise();" class="delall">刪除</a>
						</div>
